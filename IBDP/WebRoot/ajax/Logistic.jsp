...
<html>
  ...
  <body>
<div class="col-xs-12">
	<form class="form-horizontal" role="form" action="Logistic" name="LogisticForm" id="LogisticForm" method="post" enctype="multipart/form-data" >
	<legend ><center><h2>Logistic回归</h2></center></legend>
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
										...
										<div id="accordion" class="accordion-style2">
											<div class="group">
												<h3 class="accordion-header">Logistic函数</h3>
												<div>
